...
Revision ID: 83367b49fdc9
Revises: 
Create Date: 2024-07-30 15:29:24.870524
...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['goal_id'], ['goals.id'], name=op.f('fk_communities_goal_id_goals')),
    sa.ForeignKeyConstraint(['task_id'], ['tasks.id'], name=op.f('fk_communities_task_id_tasks')),
